 ...
 */
final class Version20220211100301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kontratua_lote ADD zenbatekoaren_unitatea VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kontratua_lote DROP zenbatekoaren_unitatea, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE iraupena iraupena VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE luzapena luzapena VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
