 ...
 */
final class Version20220214111003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE egoera (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE kontratua ADD egoera_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE kontratua ADD CONSTRAINT FK_4143FE97969CE4E9 FOREIGN KEY (egoera_id) REFERENCES egoera (id)');
        $this->addSql('CREATE INDEX IDX_4143FE97969CE4E9 ON kontratua (egoera_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE kontratua DROP FOREIGN KEY FK_4143FE97969CE4E9');
        $this->addSql('DROP TABLE egoera');
        ...
        $this->addSql('DROP INDEX IDX_4143FE97969CE4E9 ON kontratua');
        $this->addSql('ALTER TABLE kontratua DROP egoera_id, CHANGE espedientea espedientea VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE izena_eus izena_eus VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE izena_es izena_es VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE oharrak oharrak LONGTEXT DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE espediente_elektronikoa espediente_elektronikoa VARCHAR(12) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE artxiboa artxiboa VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
