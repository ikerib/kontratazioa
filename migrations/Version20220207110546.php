 ...
 */
final class Version20220207110546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE kontaktuak (id INT AUTO_INCREMENT NOT NULL, saila_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_A9BA7AD039F46D1 (saila_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE kontaktuak ADD CONSTRAINT FK_A9BA7AD039F46D1 FOREIGN KEY (saila_id) REFERENCES saila (id)');
        $this->addSql('ALTER TABLE fitxategia CHANGE kontratua_id kontratua_id INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE kontaktuak');
        $this->addSql('ALTER TABLE fitxategi_mota CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`');
        $this->addSql('ALTER TABLE fitxategia CHANGE kontratua_id kontratua_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE file_name file_name VARCHAR(255) DEFAULT NULL COLLATE `utf8_unicode_ci`');
